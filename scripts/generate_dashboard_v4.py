...
# -*- coding: utf-8 -*-
"""
生成 SUNLU 库存看板 HTML v4 - 修复数据嵌入问题
"""

import json

# 读取数据
with open(r'C:\Users\Administrator\Documents\trae\inventory_data_v7.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
const DEFAULT_DATA = {{DATA_PLACEHOLDER}};
...
# 替换数据占位符
html = html_template.replace('{{DATA_PLACEHOLDER}}', data_js)
