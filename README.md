...
- 链接访问量统计页：`http://localhost:5002/shopify-links.html`。使用 ShopifyQL `FROM sessions` 报表口径，按 US/UK/FR/DE/IT 站点统计 landing page 访客、Sessions、结账、Pageviews、跳出率、平均时长和转化率，并支持不同日期区间环比。
